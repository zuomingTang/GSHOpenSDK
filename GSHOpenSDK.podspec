...
Pod::Spec.new do |s|
  s.name             = 'GSHOpenSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GSHOpenSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/zuomingTang/GSHOpenSDK.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'GSHOpenSDK' => ['GSHOpenSDK/Assets/*.png']
  # }
